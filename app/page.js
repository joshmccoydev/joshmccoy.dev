...
export default function Home() {
  return (
    <main className="container text-center sm:w-full md:w-2/3 lg:w-1/2 sm:pt-32 md:pt-28 lg:pt-80">
      <section id="about" className="pt-10">
        <h3 className="text-4xl md:text-5xl lg:text-6xl z-10 -rotate-[6.75deg]">👋Hello, World!</h3>
        <div className="flex justify-center pt-2">
            <h2 className="text-4xl md:text-5xl lg:text-6xl my-auto">I'm&nbsp;</h2>
            <h2 className="text-5xl md:text-5xl lg:text-7xl my-auto bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-transparent bg-clip-text dark:bg-gradient-to-r dark:from-indigo-500 dark:via-purple-500 dark:to-pink-500">
            Josh McCoy
            </h2>
        </div>
